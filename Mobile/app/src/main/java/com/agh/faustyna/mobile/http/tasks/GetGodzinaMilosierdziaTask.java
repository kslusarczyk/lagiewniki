 ...
 */
public class GetGodzinaMilosierdziaTask extends HttpTask {
    public GetGodzinaMilosierdziaTask(ProgressBarActivity context){
        super(context, R.string.rest_godzina_milosierdzia);
    }
