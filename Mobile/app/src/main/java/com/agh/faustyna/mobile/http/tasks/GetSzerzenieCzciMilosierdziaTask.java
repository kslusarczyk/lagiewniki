 ...
 */
public class GetSzerzenieCzciMilosierdziaTask extends HttpTask {
    public GetSzerzenieCzciMilosierdziaTask(ProgressBarActivity context){
        super(context, R.string.rest_szerzenie_czci_milosierdzia);
    }
    @Override
