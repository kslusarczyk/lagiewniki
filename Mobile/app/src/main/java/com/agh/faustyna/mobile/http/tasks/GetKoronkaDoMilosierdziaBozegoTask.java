 ...
 */
public class GetKoronkaDoMilosierdziaBozegoTask extends HttpTask {
    public GetKoronkaDoMilosierdziaBozegoTask(ProgressBarActivity context){
        super(context, R.string.rest_koronka_do_milosierdzia_bozego);
    }
    @Override
