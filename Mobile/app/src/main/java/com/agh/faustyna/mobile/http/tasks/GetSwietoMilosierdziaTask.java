 ...
 */
public class GetSwietoMilosierdziaTask extends HttpTask {

    public GetSwietoMilosierdziaTask(ProgressBarActivity context){
        super(context, R.string.rest_swieto_milosierdzia);
    }
    @Override
